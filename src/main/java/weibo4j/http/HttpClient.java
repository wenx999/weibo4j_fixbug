...
public class HttpClient implements java.io.Serializable {
  ...
  public Response multPartURL(String fileParamName, String url, PostParameter[] params, File file,
    ...
    try {
      ...
      FilePart filePart =
          new FilePart(fileParamName, file.getName(), file, new MimetypesFileTypeMap()
  ...
  public Response httpRequest(HttpMethod method, Boolean WithTokenHeader) throws WeiboException {
    ...
    try {
      ...
      if (WithTokenHeader) {
        ...
        if (acceptEncoding != null && !acceptEncoding.equalsIgnoreCase("")) {
      ...
      // fix bug #5, see
      // https://github.com/wenx999/weibo4j_fixbug/issues/5
